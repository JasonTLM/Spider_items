...
class TiebaSpider:
    ...
    def get_content_list(self, html_str):
        ...
        for div in div_list:
            ...
            item["href"] = self.part_url + \
                           div.xpath("./a/@href")[0] if len(div.xpath("./a/@href")) > 0 else None
            item["img_list"] = self.get_img_list(item["href"], [])
            item["img_list"] = [requests.utils.unquote(
                i).split("scr=")[-1] for i in item["img_list"]]
    ...
    def get_img_list(self, detail_url, total_img_list):
        ...
        # 有return返回值时，程序将不再执行return之后的程序，故不必要写else
    ...
    def run(self):
        ...
        while next_url is not None:
            ...
            # 5.请求下一页的url地址，循环2-5步


if __name__ == "__main__":
    tieba_spider = TiebaSpider("泉州信息工程学院")
    tieba_spider.run()
